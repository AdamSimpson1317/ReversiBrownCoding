...
public class MainPanel extends JFrame {
     ...
     *
     * @param moveChecker - Controls moves of player and opponent.
     */
     ...
     *
     * @param opponent - cell that opponent has chosen
     */
    private void MoveOpponent(Cell opponent){
        ...
        if (grayCells.size() == 0){
            ...
            Cell opponent2 = moveChecker.generateOpponent(OPPONENTS_CELL_STATUS);
            if (opponent2!=null) {
                opponent2.colourTemp(OPPONENTS_COLOUR, true);
                ActionListener taskPerformer = ae -> MoveOpponent(opponent2);
     ...
     *
     * @param taskPerformer - Action Listener
     */
